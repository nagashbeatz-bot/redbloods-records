...
const BUILDER_HEADS: Readonly<Record<string, string>> = {};
...
async function main() {
  ...
  ok(`${PRODUCTION_SETTING_FAMILIES_20260925.length} production families pinned`, PRODUCTION_SETTING_FAMILIES_20260925.length === 29);
