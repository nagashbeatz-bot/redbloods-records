...
async function main() {
  ...
  console.log("Boundaries (123-132)");
  {
    ...
    ok("129. provenance parser untouched (owner_manual only)", /if \(k !== "source"\) errors\.push/.test(rd("lib/partner/investigation/context-row.ts")) && /raw\.source !== "owner_manual"/.test(rd("lib/partner/investigation/context-row.ts")));
