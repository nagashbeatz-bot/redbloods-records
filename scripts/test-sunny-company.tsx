...
function main() {
  ...
  check("TABLE_COVERAGE = the 55 production tables (2026-09-25 census − the retired assistant's table + the 4 Universal Action Layer tables applied 2026-09-26, migration 6d82d93a)", Object.keys(CO.TABLE_COVERAGE).length, 55);
