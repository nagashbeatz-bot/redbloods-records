...
function main() {
  ...
  check("baseline versions (system ≥ project contract)", [((a: string, b: string) => { const [da, na] = a.split("-"), [db, nb] = b.split("-"); return da > db || (da === db && Number(na) >= Number(nb)); })(SYSTEM_BASELINE_VERSION, PROJECT_BASELINE_VERSION), PROJECT_BASELINE_VERSION], [true, "2026.09.25-3"]);
