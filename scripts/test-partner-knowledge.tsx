...
void (async () => {
  ...
  console.log("\n9. static guards");
  {
    ...
    ok("MCP audit tool type = the 3 read tools + the P1 answer tool + the P2 knowledge tool only (matches the P2 audit CHECK candidate; partner_query stays NULL)", /tool: "partner_brief" \| "partner_resolve" \| "partner_entity" \| "partner_answer_question" \| "partner_propose_knowledge" \| null;/.test(fs.readFileSync(path.join(root, "lib/integrations/partner-mcp/store.ts"), "utf8")));
