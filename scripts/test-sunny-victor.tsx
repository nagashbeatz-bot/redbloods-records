...
function main() {
  ...
  ok("VICTOR = DEEP_BRAIN_V1; Steven / Mix / Red Films NOT marked complete", DOMAIN_KNOWLEDGE_DEPTH.VICTOR === "DEEP_BRAIN_V1" && CAPABILITY_CHANGES.some((x) => x.version === "2026.09.25-10" && x.domain === "VICTOR"));
