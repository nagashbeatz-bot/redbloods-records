...
import { getBalanceCycleState, setBalanceCycleAnchor } from "@/lib/artist-balance-cycles-store";
 ...
 *   POST /api/label/artists/[id]/balance/cycles   → { anchorDate } sets the (one-time) anchor
 */
