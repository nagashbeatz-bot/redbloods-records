...
export const SETTINGS_FAMILIES: readonly SettingsFamily[] = [
  ...
  F("REPORT_SCHEDULE", A, "REPORTS", "The weekly email report schedule / configuration", "Owner", "SYSTEM_SETTINGS", "NONE", "^report_schedule$", { in: ["report_schedule"] }),
...
export const PRODUCTION_SETTING_FAMILIES_20260925 = [
  "ai_budget_<date>", "ai_log_<date>", "album_finance_<id>", "album_prev_info_<id>", "availability_reminder:shalev-tasama:<date>:fri-0900",
