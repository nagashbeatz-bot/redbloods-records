...
export const KNOWLEDGE_GAPS: readonly KnowledgeGap[] = [
  ...
  G({ id: "VIC_PORTAL_FILE_SECURITY", domain: "VICTOR", entityType: "file access", class: "SYSTEM_BEHAVIOR_GAP",
    description: "Victor can inject file paths / his work folder and then stream, delete or upload anywhere in the storage account; he can delete the Owner's uploads; upload responses leak paths and public links; several storage routes rely on the proxy only", redbloodsKnows: "behavior", sunnyKnows: "the finding (see security gaps) — never tested destructively",
    why: "unvalidated fields in Victor's PATCH allowlist", wouldClose: "a security-fix mission", relationshipsAffected: ["Victor → storage"], risk: "HIGH", ownerImpact: "company files are exposed to Victor's account", futureActionImpact: "none", status: "SECURITY_REMEDIATION_REQUIRED", appRemediation: "SECURITY_FIX", sunnyReadsVia: ["system_awareness:victor_model"] }),
