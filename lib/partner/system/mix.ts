...
export const MIX_INTEGRITY = {
  productionCounts20260925: {
    ...
    completedWithoutFinalFiles: 4, completedWithOpenComments: 5, completedUnpaid: 3, completedWithoutAnyVersion: 3,
    ...
    mixFollowUpTasks: 4, mixAgentAlertTypes: 0, pushMarkers: { mixReady: 6, payment: 6 }, reminderClaims: 149, lastPortalVisit: "2026-09-23", lastLoginSeen: "2026-08-25", recordedNotesSends: "12 on the riddim work (from reminder claims)", albumTracksMixMaster: { "לא התחיל": 5 },
  },
  findingsHe: [
