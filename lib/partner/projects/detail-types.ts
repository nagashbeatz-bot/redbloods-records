...
export interface DetailAgentAlert { projectId: string | null; type: string | null; severity: string | null; title: string | null; message: string | null; status: string | null; source: string | null; relatedClientId: string | null; metadata: unknown; suggestedActions: unknown; sentNotification: unknown; entityKey: string | null; createdAt: string | null; updatedAt: string | null }
