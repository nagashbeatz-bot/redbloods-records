...
export interface DetailEngineerWork { id: string; projectId: string | null; engineerName: string | null; notes: string | null; hasFilesLink: boolean; sortOrder: number | null; createdAt: string | null; updatedAt: string | null }
