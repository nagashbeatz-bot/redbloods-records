...
export async function addFileToProject(
  id: string,
  file: { name: string; assetId?: number; url?: string; dropboxPath?: string; dropboxShareUrl?: string; trackId?: string; versionLabel?: string; category?: string; durationSeconds?: number; size?: number; sourceMixVersionId?: string }
): Promise<void> {
  ...
  const current: { name: string; assetId?: number; url?: string; dropboxPath?: string; dropboxShareUrl?: string; trackId?: string; versionLabel?: string; category?: string; durationSeconds?: number; size?: number; sourceMixVersionId?: string }[] =
