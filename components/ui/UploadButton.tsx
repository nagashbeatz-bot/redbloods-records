      ...
      <div style={{ position: "relative", flexShrink: 0 }}>
        ...
        <button
          ...
          style={{
            ...
            background: showRing ? "transparent" : "rgba(255,255,255,0.04)",
            color: iconColor,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 11, flexShrink: 0, transition: "color 0.2s, background 0.2s",
          }}
          onMouseEnter={(e) => {
        ...
        >
          ...
          {/* Indeterminate spinner — only while progress is 0 */}
