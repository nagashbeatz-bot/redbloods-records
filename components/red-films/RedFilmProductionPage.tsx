                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
                    <div>
                      ...
                      <div style={{ fontSize: 13, color: "#CCC", marginTop: 3 }}>{prod.edit_status}</div>
                    </div>
                    {prod.publish_date && (
                      <div>
                        <div style={{ fontSize: 10, color: "#555" }}>פרסום מתוכנן</div>
                        <div style={{ fontSize: 13, color: "#CCC", marginTop: 3 }}>{fmtDate(prod.publish_date)}</div>
                      </div>
                    )}
                    {prod.published_where && (
                      <div>
                        <div style={{ fontSize: 10, color: "#555" }}>פורסם ב</div>
                        <div style={{ fontSize: 13, color: "#CCC", marginTop: 3 }}>{prod.published_where}</div>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  {(prod.script_start || prod.script_middle || prod.script_end) && (
                    <>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                        {[
                          ["התחלה", prod.script_start],
                          ["אמצע",  prod.script_middle],
                          ["סוף",   prod.script_end],
                        ].map(([lbl, val]) => (
                          <div key={lbl} style={{ background: "#141414", border: "1px solid #1E1E1E", borderRadius: 8, padding: "10px 12px" }}>
                            ...
                            <div style={{ fontSize: 12, color: val ? "#CCC" : "#333", lineHeight: 1.6, whiteSpace: "pre-wrap", fontStyle: val ? "normal" : "italic" }}>
                              {val || "לא הוזן"}
                            </div>
                          </div>
                        ))}
                  ...
                  {(prod.director_notes || prod.photographer_notes) && (
                    <>
                      ...
                      {prod.director_notes && (
                        <div>
                          <div style={{ fontSize: 10, color: "#555", marginBottom: 4 }}>הערות בימוי</div>
                          <div style={{ fontSize: 12, color: "#CCC", whiteSpace: "pre-wrap", lineHeight: 1.6 }}>{prod.director_notes}</div>
                        </div>
                      )}
                      {prod.photographer_notes && (
                        <div>
                          <div style={{ fontSize: 10, color: "#555", marginBottom: 4 }}>הערות לצלם</div>
                          <div style={{ fontSize: 12, color: "#CCC", whiteSpace: "pre-wrap", lineHeight: 1.6 }}>{prod.photographer_notes}</div>
                        </div>
                      )}
                    </>
                  )}
                  ...
                  {prod.ref_links && (
                    <>
                      <SDivider />
                      <div>
                        <div style={{ fontSize: 10, color: "#555", marginBottom: 4 }}>רפרנסים</div>
                        <div style={{ fontSize: 12, color: "#60A5FA", whiteSpace: "pre-wrap" }}>{prod.ref_links}</div>
                      </div>
                    </>
                  )}
                </div>
